...
const LandingPage: React.FC<{ onStart: () => void }> = ({ onStart }) => {
  return (
    <div className="min-h-screen bg-[#0B1120] text-slate-100 flex flex-col font-sans selection:bg-yellow-500/30 relative">
      {/* Navbar */}
      <nav className="flex items-center justify-between px-6 py-5 max-w-7xl mx-auto w-full z-20">
      ...
      {/* Hero Section */}
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 mt-10 md:mt-0 relative overflow-hidden pb-20">
        {/* Background Glow */}
        ...
        <button 
          onClick={onStart}
          className="group relative inline-flex items-center justify-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-slate-900 text-lg font-bold px-8 py-4 rounded-full transition-all transform hover:scale-105 shadow-[0_0_40px_-10px_rgba(234,179,8,0.5)] z-20"
        >
          Start Chatting
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-5xl text-slate-400 text-sm z-20 relative">
             <div className="p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-yellow-500/30 transition-colors backdrop-blur-sm">
        ...
        <div className="mt-16 mb-8 text-slate-600 text-xs text-center max-w-lg mx-auto z-20 relative">
...
export const App: React.FC = () => {
  ...
  return (
    <div className="h-[100dvh] bg-slate-950 text-slate-200 flex flex-col relative selection:bg-yellow-500/30 overflow-hidden">
