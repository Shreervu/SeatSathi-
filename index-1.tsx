...
// Combine all colleges (merging partial colleges)
...
export const kcetData: KCETData = {
  metadata,
  colleges,
};
...
export function getCollege(code: string): College | undefined {
